		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#googleimagens-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"googleimagens-display": {
								"semanticObject": "googleimagens",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=googleimagens",
									"url": sap.ui.require.toUrl("googleimagens")
								}
							}
						}
					}
